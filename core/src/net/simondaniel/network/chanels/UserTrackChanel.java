...
public class UserTrackChanel extends MessageChannel{

	public UserTrackChanel() {
		super("UserTracking", new ClientState(), new ServerState());
	}
	...
	private static class ServerState extends MessageChannelEnd{
		...
		public ServerState() {
			super(new Class<?>[] {UserLeftS.class, UserListC.class, LobbyCreateC.class, LobbyJoinC.class});
		}
